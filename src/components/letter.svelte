<script lang="ts">
	...
	import letterDeco from '$lib/assets/ribon.png';
	...
	<div class="letter-container">
		...
		{:else}
			<div class="family-description kr">
				<p>
					류창수<span class="name-divider">{@html nameDivider}</span> 김인이
					<span class="son">의 장남</span>류동현
				</p>
				<p>
					나상웅<span class="name-divider">{@html nameDivider}</span> 이연우<span class="daughter"
						>의 장녀</span
					>나윤서
				</p>
			</div>
