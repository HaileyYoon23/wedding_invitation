...
{#snippet account_1_content()}
	...
	>
		...
		<span class="button-text"><span class="name">{$_('contact.accordion.groom.self_name')}</span> <br /> {$_('contact.accordion.groom.self')}</span>
	</button>
	<button 
		onclick={handlePClick}
	...
	>
		<img src={copyIcon} alt="복사" class="copy-icon" />
		<span class="button-text"><span class="name">{$_('contact.accordion.groom.father_name')}</span> <br /> {$_('contact.accordion.groom.father')}</span>
	</button>
	<button 
		onclick={handlePClick}
	...
	>
		<img src={copyIcon} alt="복사" class="copy-icon" />
		<span class="button-text"><span class="name">{$_('contact.accordion.groom.mother_name')}</span> <br /> {$_('contact.accordion.groom.mother')}</span>
	</button>
{/snippet}
...
{#snippet account_2_content()}
	...
	>
		<img src={copyIcon} alt="복사" class="copy-icon" />
		<span class="button-text"><span class="name">{$_('contact.accordion.bride.self_name')}</span> <br /> {$_('contact.accordion.bride.self')}</span>
	</button>
	<button 
		onclick={handlePClick}
	...
	>
		<img src={copyIcon} alt="복사" class="copy-icon" />
		<span class="button-text"><span class="name">{$_('contact.accordion.bride.father_name')}</span> <br /> {$_('contact.accordion.bride.father')}</span>
	</button>
	<button 
		onclick={handlePClick}
	...
	>
		<img src={copyIcon} alt="복사" class="copy-icon" />
		<span class="button-text"><span class="name">{$_('contact.accordion.bride.mother_name')}</span> <br /> {$_('contact.accordion.bride.mother')}</span>
	</button>
{/snippet}
