...
declare class __sveltets_Render<T extends string, Multiple extends boolean> {
    props(): Omit<ComponentProps<ComboboxProps<T, Multiple>>, "multiple"> & {
        children: Snippet<[Builder<T, Multiple>]>;
        multiple?: Multiple | undefined;
    };
    events(): {};
    slots(): {};
    bindings(): "value" | "highlighted";
    exports(): {
...
type Combobox<T extends string, Multiple extends boolean> = InstanceType<typeof Combobox<T, Multiple>>;
